...
CREATE TABLE `admit` (
  ...
  `dc_detail` int(4) NOT NULL,
  `ad_remark` text NOT NULL
...
INSERT INTO `admit` (`id`, `profile_id`, `admit_date`, `dc_date`, `dc_detail`, `ad_remark`) VALUES
(1, 1, '0000-00-00 00:00:00', '2022-04-01', 1, ''),
(2, 3, '2022-03-03 16:40:17', NULL, 1, ''),
(3, 4, '2022-03-04 21:20:56', NULL, 0, '');
...
CREATE TABLE `allergies` (
  `id` int(4) NOT NULL,
  `profile_id` int(4) NOT NULL,
  `aller_name` varchar(50) DEFAULT NULL,
  `aller_status` int(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `allergies` (`id`, `profile_id`, `aller_name`, `aller_status`) VALUES
(1, 1, NULL, 0),
(2, 3, NULL, 0),
(3, 4, NULL, 0);
...
CREATE TABLE `country_detail` (
  `id` int(3) NOT NULL,
  `ct_nameENG` varchar(200) NOT NULL,
  `ct_nameTHA` varchar(200) NOT NULL,
...
INSERT INTO `country_detail` (`id`, `ct_nameENG`, `ct_nameTHA`, `ct_status`) VALUES
(1, 'Aruba', 'อารูบา', 0),
(2, 'Afghanistan', 'อัฟกานิสถาน', 0),
(3, 'Angola', 'แองโกลา', 0),
(4, 'Anguilla', 'แองกวิลลา', 0),
(5, 'Åland', 'โอลันด์', 0),
(6, 'Albania', 'แอลเบเนีย', 0),
(7, 'Andorra', 'อันดอร์รา', 0),
(8, 'United Arab Emirates', 'สหรัฐอาหรับเอมิเรตส์\n', 0),
(9, 'Argentina', 'อาร์เจนตินา', 0),
(10, 'Armenia', 'อาร์เมเนีย', 0),
(11, 'American Samoa', 'อเมริกันซามัว', 0),
(12, 'Antarctica', 'ทวิปแอนตาร์กติกา', 0),
(13, 'French Southern Territories', 'ดินแดนทางตอนใต้ของฝรั่งเศส', 0),
(14, 'Antigua and Barbuda', 'แอนติกาและบาร์บูดา', 0),
(15, 'Australia', 'ออสเตรเลีย', 0),
(16, 'Austria', 'ออสเตรีย', 0),
(17, 'Azerbaijan', 'อาเซอร์ไบจาน', 0),
(18, 'Burundi', 'บุรุนดี', 0),
(19, 'Belgium', 'เบลเยียม', 0),
(20, 'Benin', 'เบนิน', 0),
(21, 'Bonaire', 'โบแนร์', 0),
(22, 'Burkina Faso', 'บูร์กินาฟาโซ', 0),
(23, 'Bangladesh', 'บังคลาเทศ', 0),
(24, 'Bulgaria', 'บัลแกเรีย', 0),
(25, 'Bahrain', 'บาห์เรน', 0),
(26, 'Bahamas', 'บาฮามาส', 0),
(27, 'Bosnia and Herzegovina', 'บอสเนียและเฮอร์เซโก\n', 0),
(28, 'Saint Barthélemy', 'Saint Barthélemy', 0),
(29, 'Belarus', 'เบลารุส', 0),
(30, 'Belize', 'เบลีซ', 0),
(31, 'Bermuda', 'เบอร์มิวดา', 0),
(32, 'Bolivia', 'โบลิเวีย', 0),
(33, 'Brazil', 'บราซิล', 0),
(34, 'Barbados', 'บาร์เบโดส', 0),
(35, 'Brunei', 'บรูไน', 0),
(36, 'Bhutan', 'ภูฏาน', 0),
(37, 'Bouvet Island', 'เกาะบูเว็ต', 0),
(38, 'Botswana', 'บอตสวานา', 0),
(39, 'Central African Republic', 'สาธารณรัฐแอฟริกากลาง', 0),
(40, 'Canada', 'แคนาดา', 0),
(41, 'Cocos [Keeling] Islands', 'เกาะโคโคส [คีลิง]', 0),
(42, 'Switzerland', 'สวิสเซอร์แลนด์', 0),
(43, 'Chile', 'ชิลี', 0),
(44, 'China', 'จีน', 0),
(45, 'Ivory Coast', 'ไอวอรี่โคสต์', 0),
(46, 'Cameroon', 'แคเมอรูน', 0),
(47, 'Democratic Republic of the Congo', 'สาธารณรัฐประชาธิปไตยคองโก', 0),
(48, 'Republic of the Congo', 'สาธารณรัฐคองโก', 0),
(49, 'Cook Islands', 'หมู่เกาะคุก', 0),
(50, 'Colombia', 'โคลอมเบีย', 0),
(51, 'Comoros', 'คอโมโรส', 0),
(52, 'Cape Verde', 'เคปเวิร์ด', 0),
(53, 'Costa Rica', 'คอสตาริกา\n', 0),
(54, 'Cuba', 'คิวบา', 0),
(55, 'Curacao', 'คูราเซา\n', 0),
(56, 'Christmas Island', 'เกาะคริสต์มาส', 0),
(57, 'Cayman Islands', 'หมู่เกาะเคย์เเมน', 0),
(58, 'Cyprus', 'ไซปรัส', 0),
(59, 'Czech Republic', 'สาธารณรัฐเช็ก', 0),
(60, 'Germany', 'เยอรมันนี', 0),
(61, 'Djibouti', 'จิบูตี', 0),
(62, 'Dominica', 'โดมินิกา', 0),
(63, 'Denmark', 'เดนมาร์ก', 0),
(64, 'Dominican Republic', 'สาธารณรัฐโดมินิกัน\n', 0),
(65, 'Algeria', 'แอลจีเรีย', 0),
(66, 'Ecuador', 'เอกวาดอร์', 0),
(67, 'Egypt', 'อียิปต์', 0),
(68, 'Eritrea', 'เอริเทรี', 0),
(69, 'Western Sahara', 'ซาฮาร่าตะวันตก', 0),
(70, 'Spain', 'สเปน', 0),
(71, 'Estonia', 'เอสโตเนีย', 0),
(72, 'Ethiopia', 'สาธารณรัฐเอธิโอเปีย', 0),
(73, 'Finland', 'ฟินแลนด์', 0),
(74, 'Fiji', 'ฟิจิ', 0),
(75, 'Falkland Islands', 'หมู่เกาะฟอล์คแลนด์', 0),
(76, 'France', 'ฝรั่งเศส', 0),
(77, 'Faroe Islands', 'หมู่เกาะแฟโร', 0),
(78, 'Micronesia', 'ไมโครนีเซีย', 0),
(79, 'Gabon', 'กาบอง', 0),
(80, 'United Kingdom', 'อังกฤษ (สหราชอาณาจักร)', 0),
(81, 'Georgia', 'จอร์เจีย', 0),
(82, 'Guernsey', 'เกิร์นซีย์', 0),
(83, 'Ghana', 'เกิร์นซีย์', 0),
(84, 'Gibraltar', 'ยิบรอลตา', 0),
(85, 'Guinea', 'กินี', 0),
(86, 'Guadeloupe', 'กัวเดลุฟ', 0),
(87, 'Gambia', 'แกมเบีย', 0),
(88, 'Guinea-Bissau', 'กินีบิสเซา', 0),
(89, 'Equatorial Guinea', 'อิเควทอเรียลกินี', 0),
(90, 'Greece', 'กรีซ', 0),
(91, 'Grenada', 'เกรเนดา ', 0),
(92, 'Greenland', 'กรีนแลนด์', 0),
(93, 'Guatemala', 'กัวเตมาลา', 0),
(94, 'French Guiana', 'เฟรนช์เกียนา', 0),
(95, 'Guam', 'เกาะกวม', 0),
(96, 'Guyana', 'กายอานา', 0),
(97, 'Hong Kong', 'ฮ่องกง', 0),
(98, 'Heard Island and McDonald Islands', 'เกาะเฮิร์ดและหมู่เกาะแมคโดนัลด์', 0),
(99, 'Honduras', 'ฮอนดูรัส', 0),
(100, 'Croatia', 'โครเอเชีย', 0),
(101, 'Haiti', 'เฮติ', 0),
(102, 'Hungary', 'ฮังการี', 0),
(103, 'Indonesia', 'อินโดนีเซีย', 0),
(104, 'Isle of Man', 'เกาะแมน', 0),
(105, 'India', 'อินเดีย', 0),
(106, 'British Indian Ocean Territory', 'หมู่เกาะบริติชเวอร์จิน', 0),
(107, 'Ireland', 'ไอร์แลนด์', 0),
(108, 'Iran', 'อิหร่าน', 0),
(109, 'Iraq', 'อิรัก', 0),
(110, 'Iceland', 'ประเทศไอซ์แลนด์', 0),
(111, 'Israel', 'อิสราเอล', 0),
(112, 'Italy', 'อิตาลี', 0),
(113, 'Jamaica', 'เกาะจาเมกา', 0),
(114, 'Jersey', 'นิวเจอร์ซีย์', 0),
(115, 'Jordan', 'จอร์แดน', 0),
(116, 'Japan', 'ญี่ปุ่น', 0),
(117, 'Kazakhstan', 'คาซัคสถาน', 0),
(118, 'Kenya', 'เคนย่า', 0),
(119, 'Kyrgyzstan', 'คีร์กีสถาน', 0),
(120, 'Cambodia', 'กัมพูชา', 0),
(121, 'Kiribati', 'คิริบาส', 0),
(122, 'Saint Kitts and Nevis', 'เซนต์คิตส์และเนวิส', 0),
(123, 'South Korea', 'เกาหลีใต้', 0),
(124, 'Kuwait', 'คูเวต', 0),
(125, 'Laos', 'ลาว', 0),
(126, 'Lebanon', 'เลบานอน', 0),
(127, 'Liberia', 'ประเทศไลบีเรีย', 0),
(128, 'Libya', 'ลิบยา', 0),
(129, 'Saint Lucia', 'เซนต์ลูเซีย', 0),
(130, 'Liechtenstein', 'นสไตน์', 0),
(131, 'Sri Lanka', 'ศรีลังกา', 0),
(132, 'Lesotho', 'เลโซโท', 0),
(133, 'Lithuania', 'ลิธัวเนีย', 0),
(134, 'Luxembourg', 'ลักเซมเบิร์ก', 0),
(135, 'Latvia', 'ลัตเวีย', 0),
(136, 'Macao', 'มาเก๊า', 0),
(137, 'Saint Martin', 'เซนต์มาร์ติน', 0),
(138, 'Morocco', 'โมร็อกโก', 0),
(139, 'Monaco', 'โมนาโก', 0),
(140, 'Moldova', 'มอลโดวา', 0),
(141, 'Madagascar', 'มาดากัสการ์', 0),
(142, 'Maldives', 'มัลดีฟส์', 0),
(143, 'Mexico', 'เม็กซิโก', 0),
(144, 'Marshall Islands', 'หมู่เกาะมาร์แชลล์', 0),
(145, 'Macedonia', 'มาซิโดเนีย', 0),
(146, 'Mali', 'มาลี', 0),
(147, 'Malta', 'เกาะมอลตา', 0),
(148, 'Myanmar [Burma]', 'พม่า', 0),
(149, 'Montenegro', 'มอนเตเนโก', 0),
(150, 'Mongolia', 'มองโกเลีย', 0),
(151, 'Northern Mariana Islands', 'หมู่เกาะนอร์เทิร์นมาเรียนา', 0),
(152, 'Mozambique', 'โมซัมบิก', 0),
(153, 'Mauritania', 'มอริเตเนีย', 0),
(154, 'Montserrat', 'มอนต์เซอร์รัต', 0),
(155, 'Martinique', 'มาร์ตินีก', 0),
(156, 'Mauritius', 'มอริเชียส', 0),
(157, 'Malawi', 'มาลาวี', 0),
(158, 'Malaysia', 'มาเลเซีย', 0),
(159, 'Mayotte', 'มายอต', 0),
(160, 'Namibia', 'นามิเบีย', 0),
(161, 'New Caledonia', 'นิวแคลิโดเนีย', 0),
(162, 'Niger', 'ไนเธอร์', 0),
(163, 'Norfolk Island', 'เกาะนอร์ฟอล์ก', 0),
(164, 'Nigeria', 'ไนจีเรีย', 0),
(165, 'Nicaragua', 'นิการากัว', 0),
(166, 'Niue', 'นีอูเอ', 0),
(167, 'Netherlands', 'เนเธอร์แลนด์', 0),
(168, 'Norway', 'นอร์เวย์', 0),
(169, 'Nepal', 'เนปาล', 0),
(170, 'Nauru', 'นาอูรู', 0),
(171, 'New Zealand', 'นิวซีแลนด์', 0),
(172, 'Oman', 'โอมาน', 0),
(173, 'Pakistan', 'ปากีสถาน', 0),
(174, 'Panama', 'ปานามา', 0),
(175, 'Pitcairn Islands', 'หมู่เกาะพิตแคร์น', 0),
(176, 'Peru', 'เปรู', 0),
(177, 'Philippines', 'ฟิลิปปินส์', 0),
(178, 'Palau', 'ปาเลา', 0),
(179, 'Papua New Guinea', 'ปาปัวนิวกินี', 0),
(180, 'Poland', 'โปแลนด์', 0),
(181, 'Puerto Rico', 'เปอร์โตริโก', 0),
(182, 'North Korea', 'เกาหลีเหนือ', 0),
(183, 'Portugal', 'โปรตุเกส', 0),
(184, 'Paraguay', 'ปารากวัย', 0),
(185, 'Palestine', 'ปาเลสไตน์', 0),
(186, 'French Polynesia', 'เฟรนช์โปลินีเซีย', 0),
(187, 'Qatar', 'กาตาร์', 0),
(188, 'Réunion', 'เรอูนียง', 0),
(189, 'Romania', 'โรมาเนีย', 0),
(190, 'Russia', 'รัสเซีย', 0),
(191, 'Rwanda', 'รวันดา', 0),
(192, 'Saudi Arabia', 'ซาอุดิอาราเบีย', 0),
(193, 'Sudan', 'ซูดาน', 0),
(194, 'Senegal', 'เซเนกัล', 0),
(195, 'Singapore', 'สิงคโปร์', 0),
(196, 'South Georgia and the South Sandwich Islands', 'หมู่เกาะเซาท์จอร์เจียและหมู่เกาะเซาท์แซนด์วิช', 0),
(197, 'Saint Helena', 'เซนต์เฮเลนา', 0),
(198, 'Svalbard and Jan Mayen', 'สฟาลบาร์และยานไมเอน', 0),
(199, 'Solomon Islands', 'หมู่เกาะโซโลมอน', 0),
(200, 'Sierra Leone', 'เซียร์ราลีโอน', 0),
(201, 'El Salvador', 'เอลซัลวาดอร์', 0),
(202, 'San Marino', 'ซานมาริโน', 0),
(203, 'Somalia', 'โซมาเลีย', 0),
(204, 'Saint Pierre and Miquelon', 'เซนต์ปิแอร์และมีเกอลง', 0),
(205, 'Serbia', 'เซอร์เบีย', 0),
(206, 'South Sudan', 'ซูดานใต้', 0),
(207, 'São Tomé and Príncipe', 'เซาตูเมและปรินซิปี', 0),
(208, 'Suriname', 'ซูรินาเม', 0),
(209, 'Slovakia', 'สโลวะเกีย', 0),
(210, 'Slovenia', 'สโลวีเนีย', 0),
(211, 'Sweden', 'สวีเดน', 0),
(212, 'Swaziland', 'สวาซิแลนด์', 0),
(213, 'Sint Maarten', 'เกาะเซนต์มาร์ติน', 0),
(214, 'Seychelles', 'เซเชลส์', 0),
(215, 'Syria', 'ซีเรีย', 0),
(216, 'Turks and Caicos Islands', 'หมู่เกาะเติกส์และหมู่เกาะเคคอส', 0),
(217, 'Chad', 'ชาด', 0),
(218, 'Togo', 'โตโก', 0),
(219, 'Thailand', 'ไทย', 0),
(220, 'Tajikistan', 'ทาจิกิสถาน', 0),
(221, 'Tokelau', 'โตเกเลา', 0),
(222, 'Turkmenistan', 'เติร์กเมนิสถาน', 0),
(223, 'East Timor', 'ติมอร์ตะวันออก', 0),
(224, 'Tonga', 'ตองกา', 0),
(225, 'Trinidad and Tobago', 'ตรินิแดดและโตเบโก', 0),
(226, 'Tunisia', 'ตูนิเซีย', 0),
(227, 'Turkey', 'ตุรกี', 0),
(228, 'Tuvalu', 'ตูวาลู', 0),
(229, 'Taiwan', 'ไต้หวัน', 0),
(230, 'Tanzania', 'แทนซาเนีย', 0),
(231, 'Uganda', 'ยูกันดา', 0),
(232, 'Ukraine', 'ยูเครน', 0),
(233, 'U.S. Minor Outlying Islands', 'เกาะนอกรีตของสหรัฐฯ', 0),
(234, 'Uruguay', 'อุรุกวัย', 0),
(235, 'United States', 'สหรัฐอเมริกา', 0),
(236, 'Uzbekistan', 'อุซเบกิสถาน', 0),
(237, 'Vatican City', 'เมืองวาติกัน', 0),
(238, 'Saint Vincent and the Grenadines', 'เซนต์วินเซนต์และเกรนาดีนส์', 0),
(239, 'Venezuela', 'เวเนซุเอลา', 0),
(240, 'British Virgin Islands', 'หมู่เกาะบริติชเวอร์จิน', 0),
(241, 'U.S. Virgin Islands', 'หมู่เกาะเวอร์จินของสหรัฐอเมริกา', 0),
(242, 'Vietnam', 'เวียดนาม', 0),
(243, 'Vanuatu', 'วานูอาตู', 0),
(244, 'Wallis and Futuna', 'วาลลิสและฟุตูนา', 0),
(245, 'Samoa', 'ซามัว', 0),
(246, 'Kosovo', 'โคโซโว', 0),
(247, 'Yemen', 'เยเมน', 0),
(248, 'South Africa', 'แอฟริกาใต้', 0),
(249, 'Zambia', 'แซมเบีย', 0),
(250, 'Zimbabwe', 'ประเทศซิมบับเว', 0);

-- --------------------------------------------------------

--
-- Table structure for table `dc_detail`
--
...
--
-- Dumping data for table `dc_detail`
--

INSERT INTO `dc_detail` (`id`, `detail`, `status`) VALUES
(1, 'Go home', 0);

-- --------------------------------------------------------

--
-- Table structure for table `district_detail`
--

CREATE TABLE `district_detail` (
  `id` int(5) NOT NULL,
  `dt_code` varchar(4) COLLATE utf8_unicode_ci NOT NULL,
  `dt_name` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
  `dt_geo_id` int(2) NOT NULL,
  `dt_province` int(5) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `district_detail`
--

INSERT INTO `district_detail` (`id`, `dt_code`, `dt_name`, `dt_geo_id`, `dt_province`) VALUES
...
CREATE TABLE `doctor` (
  ...
  `sig_status` int(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `doctor` (`id`, `sig_name`, `sig_status`) VALUES
(1, 'ดร.เอิร์ธ', 0);
...
CREATE TABLE `duration` (
  `id` int(3) NOT NULL,
  `dura_name` varchar(50) NOT NULL,
  `dura_status` int(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `duration` (`id`, `dura_name`, `dura_status`) VALUES
(1, 'Everyday', 0);
...
CREATE TABLE `health` (
  ...
  `profile_id` int(4) NOT NULL,
  `symptom` text,
  `ls_doc` date DEFAULT NULL,
  `ls_where` varchar(70) DEFAULT NULL,
  `sig_health` varchar(100) DEFAULT '1',
...
INSERT INTO `health` (`id`, `profile_id`, `symptom`, `ls_doc`, `ls_where`, `sig_health`, `date_assessed`, `user`, `create_at`, `update_at`) VALUES
(1, 1, NULL, NULL, NULL, '1', NULL, 0, '0000-00-00 00:00:00', '2022-03-03 09:35:28'),
(2, 3, NULL, NULL, NULL, '1', NULL, 0, '0000-00-00 00:00:00', '2022-03-03 09:40:18'),
(3, 4, NULL, NULL, NULL, '1', NULL, 0, '0000-00-00 00:00:00', '2022-03-04 14:20:56');
...
INSERT INTO `medication` (`id`, `profile_id`, `create_at`, `update_at`) VALUES
(1, 1, '2022-03-03 16:35:28', '2022-03-03 09:35:28'),
(2, 3, '2022-03-03 16:40:18', '2022-03-03 09:40:18'),
(3, 4, '2022-03-04 21:20:56', '2022-03-04 14:20:56');
...
CREATE TABLE `medication_detail` (
  ...
  `med_dose` varchar(30) NOT NULL,
  `med_route` int(3) DEFAULT NULL,
  `med_frequency` varchar(20) NOT NULL,
  `med_purpose` varchar(30) NOT NULL,
  `med_time` varchar(70) DEFAULT NULL,
  `med_duration` int(2) NOT NULL DEFAULT '0',
...
INSERT INTO `medication_detail` (`id`, `med_id`, `date`, `med_name`, `med_dose`, `med_route`, `med_frequency`, `med_purpose`, `med_time`, `med_duration`, `med_status`) VALUES
(1, 3, '2022-02-22', 'dadsa', '22', 2, '1', 'อร่อย', 'Morning,Bedtime', 0, 0),
(17, 1, '2022-02-22', 'dadsa', '40ml', 2, '1', 'อร่อย', 'Morning,Evening', 1, 0),
(18, 1, '2022-02-22', 'dadsa', '40ml', 2, '1', 'อร่อย', 'Noon,Evening', 1, 0);

-- --------------------------------------------------------

--
-- Table structure for table `med_time`
--

CREATE TABLE `med_time` (
  `id` int(11) NOT NULL,
  `medtime_name` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `med_time`
--

INSERT INTO `med_time` (`id`, `medtime_name`) VALUES
(1, 'Morning'),
(2, 'Noon'),
(3, 'Evening'),
(4, 'Bedtime');
...
('m000000_000000_base', 1643873006),
('m130524_201442_init', 1643873018),
('m190124_110200_add_verification_token_column_to_user_table', 1643873018);
...
CREATE TABLE `physical` (
  `id` int(4) NOT NULL,
  `profile_id` int(4) NOT NULL,
  `height` double(3,0) NOT NULL,
  `weight` double(4,1) NOT NULL,
  `temp` double(3,1) NOT NULL,
  `pulse` int(3) NOT NULL,
  `respira` int(3) NOT NULL,
  ...
  `gini_touri` varchar(100) DEFAULT NULL,
  `neurological` varchar(100) DEFAULT NULL,
  `neurovascular` varchar(100) DEFAULT NULL,
  `integument` varchar(100) DEFAULT NULL,
  `assis_devices` varchar(100) DEFAULT NULL,
  `summary` text,
  `examiner` varchar(80) NOT NULL,
  `doctor` varchar(100) DEFAULT '1',
...
INSERT INTO `physical` (`id`, `profile_id`, `height`, `weight`, `temp`, `pulse`, `respira`, `vision`, `hearing`, `teeth`, `cardiac`, `respiratory`, `gi`, `gini_touri`, `neurological`, `neurovascular`, `integument`, `assis_devices`, `summary`, `examiner`, `doctor`, `exam_date`, `user`, `create_at`, `update_at`) VALUES
(1, 1, 0, 0.0, 55.2, 0, 0, '', '', '', '', '', '', '', '', '', '', '', '', 'เอิร์ธ เอิร์ธ เอิร์ธ', '1', '0000-00-00', 1, '2022-03-03 16:35:28', '2022-03-07 11:28:42'),
(2, 2, 0, 0.0, 0.0, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '1', '0000-00-00', 0, '2022-03-03 16:38:41', '2022-03-03 09:38:41'),
(3, 3, 0, 0.0, 0.0, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '1', '0000-00-00', 0, '2022-03-03 16:40:17', '2022-03-03 09:40:17'),
(4, 4, 0, 0.0, 0.0, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '1', '0000-00-00', 0, '2022-03-04 21:20:56', '2022-03-04 14:20:56');
...
CREATE TABLE `profile` (
  `id` int(4) NOT NULL,
  `dk_code` varchar(6) DEFAULT NULL,
  ...
  `village_no` int(10) DEFAULT NULL,
...
INSERT INTO `profile` (`id`, `dk_code`, `lastname`, `firstname`, `middlename`, `birth_date`, `nationality`, `sex`, `house_no`, `village_no`, `alley`, `road`, `sub_district`, `district`, `province`, `post`, `country`, `phone`, `email`, `idcard`, `issued_at`, `date_issue`, `passport_exp`, `user`, `status`, `create_at`, `update_at`) VALUES
(1, 'DK0001', 'เอิร์ธ', 'เอิร์ธ', 'เอิร์ธ', '1999-09-29', 5, 1, '185', 1, 'เอิร์ธ', 'เอิร์ธ', 'ชมพู', 'เมือง', 'ลำปาง', 52100, '17', '0863786610', 'earth@adsasd.asdas', '1520100131097', 'เอิร์ธ', '2022-02-02', '2022-02-14', 1, 0, '2022-03-03 10:35:28', '2022-03-10 18:11:03'),
(3, 'DK0003', 'เอิร์ธ', 'เอิร์ธ', 'เอิร์ธ', '2022-02-10', 5, 22, '185', 1, 'เอิร์ธ', 'เอิร์ธ', 'ชมพู', 'เมือง', 'ลำปาง', 52100, '17', '0863786610', 'earth@adsasd.asdas', '1520100131097', 'เอิร์ธ', '2022-02-02', '2022-02-14', 1, 0, '2022-03-03 10:40:17', '2022-03-04 09:48:45'),
(4, 'DK0004', 'เอิร์ธ', 'เอิร์ธ', 'เอิร์ธ', '2022-02-10', 5, 22, '185', 1, 'เอิร์ธ', 'เอิร์ธ', 'ชมพู', 'เมือง', 'ลำปาง', 52100, '15', '0863786610', 'earhth@asdasd.asddas', '1520100131097', 'เอิร์ธ', '2022-02-02', '2022-02-14', 1, 1, '2022-03-04 15:20:56', '2022-03-04 14:21:17');
...
CREATE TABLE `province_detail` (
  `id` int(5) NOT NULL,
  `pv_code` varchar(2) NOT NULL,
  `pv_name` varchar(150) NOT NULL,
  `pv_geo_id` int(5) NOT NULL,
  `pv_status` int(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `province_detail` (`id`, `pv_code`, `pv_name`, `pv_geo_id`, `pv_status`) VALUES
(1, '10', 'กรุงเทพมหานคร   ', 2, 0),
(2, '11', 'สมุทรปราการ   ', 2, 0),
(3, '12', 'นนทบุรี   ', 2, 0),
(4, '13', 'ปทุมธานี   ', 2, 0),
(5, '14', 'พระนครศรีอยุธยา   ', 2, 0),
(6, '15', 'อ่างทอง   ', 2, 0),
(7, '16', 'ลพบุรี   ', 2, 0),
(8, '17', 'สิงห์บุรี   ', 2, 0),
(9, '18', 'ชัยนาท   ', 2, 0),
...
(13, '22', 'จันทบุรี   ', 5, 0),
(14, '23', 'ตราด   ', 5, 0),
(15, '24', 'ฉะเชิงเทรา   ', 5, 0),
(16, '25', 'ปราจีนบุรี   ', 5, 0),
(17, '26', 'นครนายก   ', 2, 0),
(18, '27', 'สระแก้ว   ', 5, 0),
(19, '30', 'นครราชสีมา   ', 3, 0),
(20, '31', 'บุรีรัมย์   ', 3, 0),
(21, '32', 'สุรินทร์   ', 3, 0),
(22, '33', 'ศรีสะเกษ   ', 3, 0),
(23, '34', 'อุบลราชธานี   ', 3, 0),
(24, '35', 'ยโสธร   ', 3, 0),
(25, '36', 'ชัยภูมิ   ', 3, 0),
(26, '37', 'อำนาจเจริญ   ', 3, 0),
(27, '39', 'หนองบัวลำภู   ', 3, 0),
(28, '40', 'ขอนแก่น   ', 3, 0),
(29, '41', 'อุดรธานี   ', 3, 0),
(30, '42', 'เลย   ', 3, 0),
(31, '43', 'หนองคาย   ', 3, 0),
...
(55, '70', 'ราชบุรี   ', 4, 0),
(56, '71', 'กาญจนบุรี   ', 4, 0),
(57, '72', 'สุพรรณบุรี   ', 2, 0),
(58, '73', 'นครปฐม   ', 2, 0),
(59, '74', 'สมุทรสาคร   ', 2, 0),
(60, '75', 'สมุทรสงคราม   ', 2, 0),
(61, '76', 'เพชรบุรี   ', 4, 0),
(62, '77', 'ประจวบคีรีขันธ์   ', 4, 0),
(63, '80', 'นครศรีธรรมราช   ', 6, 0),
(64, '81', 'กระบี่   ', 6, 0),
(65, '82', 'พังงา   ', 6, 0),
(66, '83', 'ภูเก็ต   ', 6, 0),
(67, '84', 'สุราษฎร์ธานี   ', 6, 0),
(68, '85', 'ระนอง   ', 6, 0),
(69, '86', 'ชุมพร   ', 6, 0),
(70, '90', 'สงขลา   ', 6, 0),
(71, '91', 'สตูล   ', 6, 0),
...
CREATE TABLE `relationship` (
  `id` int(2) NOT NULL,
  `relaship_name` varchar(50) NOT NULL,
  `relaship_status` int(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `relationship` (`id`, `relaship_name`, `relaship_status`) VALUES
(1, 'Father', 0);
...
CREATE TABLE `relative` (
  `id` int(11) NOT NULL,
  `profile_id` int(4) NOT NULL,
  `rela_name` varchar(100) NOT NULL,
  `relaship_id` int(2) NOT NULL,
  `rela_house_no` varchar(10) DEFAULT NULL,
  `rela_village_no` int(10) DEFAULT NULL,
  `rela_alley` varchar(20) DEFAULT NULL,
  `rela_road` varchar(30) DEFAULT NULL,
  `rela_sub_district` varchar(30) DEFAULT NULL,
  `rela_district` varchar(30) DEFAULT NULL,
  `rela_province` varchar(30) NOT NULL,
  `rela_post` int(10) DEFAULT NULL,
  `rela_country` varchar(30) NOT NULL,
  `rela_phone` varchar(10) NOT NULL,
  `rela_email` varchar(100) DEFAULT NULL,
  `rela_status` int(1) NOT NULL DEFAULT '0',
  `create_at` datetime NOT NULL,
  `update_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `relative` (`id`, `profile_id`, `rela_name`, `relaship_id`, `rela_house_no`, `rela_village_no`, `rela_alley`, `rela_road`, `rela_sub_district`, `rela_district`, `rela_province`, `rela_post`, `rela_country`, `rela_phone`, `rela_email`, `rela_status`, `create_at`, `update_at`) VALUES
(5, 3, 'earth', 1, '1', 1, '1', '1', '1', '1', '1', 1, '10', '0863786610', 'earth52100@hotmail.com', 0, '0000-00-00 00:00:00', '2022-03-04 09:48:45'),
(23, 4, 'earth', 1, '1', 1, '1', '1', '1', '1', '1', 1, '16', '0863786610', 'earth52100@hotmail.com', 0, '0000-00-00 00:00:00', '2022-03-04 14:21:17'),
(34, 1, 'earth', 1, '1', 1, '1', '1', '1', '1', '1', 1, '10', '0863786610', 'earth52100@hotmail.com', 0, '0000-00-00 00:00:00', '2022-03-10 18:11:03');
...
CREATE TABLE `route` (
  ...
  `route_status` int(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `route` (`id`, `route_name`, `route_status`) VALUES
(1, 'Oral = O', 0),
(2, 'Injection', 0),
(3, 'Topical application', 0),
(4, 'Suppositories', 0),
(5, 'Sublingual', 0),
(6, 'Inhalation', 0);
...
--
-- Table structure for table `subdistrict_detail`
--

CREATE TABLE `subdistrict_detail` (
  `id` int(5) NOT NULL,
  `sd_code` varchar(6) COLLATE utf8_unicode_ci NOT NULL,
  `sd_name` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
  `sd_district` int(5) NOT NULL,
  `sd_province` int(5) NOT NULL,
  `sv_geo_id` int(2) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `subdistrict_detail`
--

INSERT INTO `subdistrict_detail` (`id`, `sd_code`, `sd_name`, `sd_district`, `sd_province`, `sv_geo_id`) VALUES
...
--
-- Table structure for table `symptom_detail`
--

CREATE TABLE `symptom_detail` (
  `id` int(3) NOT NULL,
  `symp_name` varchar(70) NOT NULL,
  `symp_status` int(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `symptom_detail`
--

INSERT INTO `symptom_detail` (`id`, `symp_name`, `symp_status`) VALUES
(1, 'Oriented x 3', 0),
(2, 'Restless at night', 0),
(3, 'Dementia diagnosis', 0),
(4, 'Forgetful', 0),
(5, 'Ambulatory', 0),
(6, 'Wheelchair', 0),
(7, 'Transfers self', 0),
(8, 'Dependent for transfer', 0),
(9, 'No pain', 0),
(10, 'Pain prosent', 0),
(11, 'Intact skin', 0),
(12, 'Walker', 0),
(13, 'Wheeled Walker', 0),
(14, 'Cane', 0),
(15, 'Alternating pressure mattress', 0),
(16, 'Oxygen', 0),
(17, 'Blood sugar monitoring device', 0),
(18, 'Foley catheler', 0);
...
(1, 'admin', 'z3ivRcMq27yYCqEOz4uLnsNJWLybX6wM', '$2y$13$2t3t.0/IszM.TdRILzUG4uDtVs9x9OrVsc9.ykReKvN6BdTM30FYa', NULL, 'admin@admin.com', 10, 1643873657, 1643873657, '-SRgAagjvMuVCI1AiZV-1cz1eMlnfNj9_1643873657');
...
INSERT INTO `visa` (`id`, `profile_id`, `create_at`, `update_at`) VALUES
(1, 1, '2022-03-03 16:35:28', '2022-03-03 09:35:28'),
(3, 3, '2022-03-03 16:40:17', '2022-03-03 09:40:17'),
(4, 4, '2022-03-04 21:20:56', '2022-03-04 14:20:56');
...
CREATE TABLE `visa_detail` (
  `id` int(11) NOT NULL,
  `visa_id` int(4) NOT NULL,
  `visa_type` int(2) NOT NULL,
  `visa_issue` date NOT NULL,
  `visa_exp` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `visa_detail`
--

INSERT INTO `visa_detail` (`id`, `visa_id`, `visa_type`, `visa_issue`, `visa_exp`) VALUES
(2, 1, 2, '2022-02-22', '2022-02-22'),
(3, 1, 5, '2022-02-22', '2022-02-22');
...
CREATE TABLE `visa_type` (
  ...
  `visa_status` int(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `visa_type` (`id`, `visa_name`, `visa_status`) VALUES
(1, 'Transit Visa', 0),
(2, 'Tourist Visa', 0),
(3, 'Non-Immigrant Visa', 1),
(4, 'Diplomatic Visa', 0),
(5, 'Official Visa', 0),
(6, 'Courtesy Visa', 0),
(7, 'Long Stay O-A , O-X', 0);
...
--
-- Indexes for table `dc_detail`
--
ALTER TABLE `dc_detail`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `district_detail`
--
ALTER TABLE `district_detail`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `medication_detail`
--
ALTER TABLE `medication_detail`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `med_time`
--
...
--
-- Indexes for table `province_detail`
--
ALTER TABLE `province_detail`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `subdistrict_detail`
--
ALTER TABLE `subdistrict_detail`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `symptom_detail`
--
ALTER TABLE `symptom_detail`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `country_detail`
  MODIFY `id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=251;

--
-- AUTO_INCREMENT for table `dc_detail`
--
ALTER TABLE `dc_detail`
  MODIFY `id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `district_detail`
--
ALTER TABLE `district_detail`
  MODIFY `id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1023;
...
--
-- AUTO_INCREMENT for table `medication_detail`
--
ALTER TABLE `medication_detail`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `med_time`
--
ALTER TABLE `med_time`
...
--
-- AUTO_INCREMENT for table `province_detail`
--
ALTER TABLE `province_detail`
...
--
-- AUTO_INCREMENT for table `subdistrict_detail`
--
ALTER TABLE `subdistrict_detail`
  MODIFY `id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8915;

--
-- AUTO_INCREMENT for table `symptom_detail`
--
ALTER TABLE `symptom_detail`
